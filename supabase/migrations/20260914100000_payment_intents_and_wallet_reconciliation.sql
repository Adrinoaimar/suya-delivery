...
begin
  if (new.id, new.code, new.customer_id, new.restaurant_id, new.subtotal, new.delivery_fee,
      ...
      new.delivery_reference, new.delivery_latitude, new.delivery_longitude,
      new.estimated_minutes, new.created_at)
    is distinct from
     (old.id, old.code, old.customer_id, old.restaurant_id, old.subtotal, old.delivery_fee,
      ...
      old.delivery_reference, old.delivery_latitude, old.delivery_longitude,
      old.estimated_minutes, old.created_at) then
