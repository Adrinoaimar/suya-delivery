...
Estado de incorporación: 12 de septiembre de 2026 (`America/Lima`). La autorización comercial
...
| La Waka Fast Food | `public/brand/stores/la-waka-logo.webp` | Fuente pública oficial: <https://lawakachicken.com/newlogo.png>; convertido a WebP sin pérdida y con transparencia | Publicado |
...
| Andá Paya | `public/brand/stores/anda-paya-logo.webp` y carta original `public/images/stores/anda-paya/menus/carta-2026-09-06.jpg` | Encabezado de la carta suministrada por el negocio; recorte nítido con fondo exterior transparente y autorización comercial recibida | Publicado |
...
La migración `20260912101000_add_coming_soon_brands.sql` replica esas cuatro fichas en Supabase con
logo y nombre, pero sin productos, horario, delivery ni contacto inventados. Quedan visibles para
anunciar «Próximamente» y con `accepting_orders = false` hasta completar el alta comercial.
