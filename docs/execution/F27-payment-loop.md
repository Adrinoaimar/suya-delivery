...
Estado del código: commit `762d7e0` (preselección temprana de cuenta sobre `a5cd734`; identificación Android sobre `53cb470`; funcionalidad de pagos en `66d808f` y `a35faa6`); CI valida base de datos, frontend, E2E, Android e iOS. Este documento no contiene llaves ni datos de clientes.
