...
| P-11 | En verificación | Copy no promete confirmación; declaración separada, pagador opcional, reset por intento, reembolso sin QR/reintento y destinatario activo visible/validado antes del QR; lectura adicional ligada al restaurante del pedido; sin QR válido tampoco se invita a pagar; focal pagos/UI 29/29 | Revisión sobre APK final y estados reales |
