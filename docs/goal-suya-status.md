...
| P-11 | En verificación | Copy no promete confirmación; declaración separada, pagador opcional, reset por intento, reembolso sin QR/reintento y destinatario activo visible/validado antes del QR; lectura adicional ligada al restaurante del pedido; focal pagos/UI 28/28 | Revisión sobre APK final y estados reales |
