...
export default function UnauthorizedPage() {
  ...
  return (
    <>
      <SeoHead
        title="Acceso no autorizado | Suya Delivery"
        description="Esta cuenta no tiene permisos para acceder a la aplicación solicitada."
        path="/unauthorized"
        noIndex
      />
      <main
        id="contenido"
        className="bg-suya-cream grid min-h-dvh place-items-center px-4 text-center"
      >
